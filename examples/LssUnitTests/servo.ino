...
void test_servo_set_position_s5_125()
{
  ...
  test_report("servo_set_position_s5_125", rig.sim.servos[1].position==125);
}

void test_servo_query_read_async()
{
  String test_name = "test_servo_set_position_read_async";
  SimChannel sim;
  ...
  if(!w.isComplete())
    test_name += "   (async didnt complete)";
...
{
  String test_name = "test_servo_set_position_read_async2";
  LssTestRig rig;
...
void test_servos()
{
  test_head("Servo and Channel class");
